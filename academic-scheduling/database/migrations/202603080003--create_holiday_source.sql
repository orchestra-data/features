...
CREATE INDEX idx_holiday_source_company_year ON holiday_source(company_id, year);
CREATE INDEX idx_holiday_source_tenant ON holiday_source(tenant_id) WHERE tenant_id IS NOT NULL;
CREATE UNIQUE INDEX idx_holiday_source_unique_sync
